...
setenv HEPMCBASE "srm://t3se01.psi.ch:8443/srm/managerv2?SFN=/pnfs/psi.ch/cms/trivcat/store/user/ursl/h/v3/sherpa/hepmc"
...
date
cd ./delphes
lcg-cp -b -D srmv2 "$HEPMCBASE"/$JOB.hepmc file:///`pwd`/$JOB.hepmc

./DelphesHepMC ./delphes_card_CMS.tcl $JOB-delphes.root ./$JOB.hepmc
ls -l 
