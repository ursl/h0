...
setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:/shome/ursl/h/HepMC-2.06.0/lib
...
/bin/cp /shome/ursl/h/prod/jobs/pythia/*/$JOB .
ls -l 
date
tar zxvf $JOB.tar.gz
